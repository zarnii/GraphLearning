...
namespace GraphAppTest
{
    ...
    public class IncidenceMatrixTest
    {
        ...
        public void IncidenceMatrix_Create_Success(
            ICollection<Vertex> vertices,
            ICollection<Connection> connections,
            int[,] expectedMatrix)
        {
            var matrix = new IncidenceMatrix(vertices, connections);
        ...
        private static IEnumerable<object?[]> GenerateDate()
        {
            ...
            yield return new object[3]
            {
                ...
                {
                    new Connection((_1, _2), 1),
                    new Connection((_2, _5), 2),
                    new Connection((_5, _3), 3),
                    new Connection((_2, _3), 4),
